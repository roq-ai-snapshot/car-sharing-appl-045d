  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Sharing Application, where we are reinventing transportation by making car sharing convenient, affordable, and efficient for everyone."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application, where we are reinventing transportation by making car sharing convenient, affordable, and efficient for everyone.`}
            </Text>
            <Box
